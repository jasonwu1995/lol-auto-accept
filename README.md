...
* Disable OpenSSL verification certificate errors and see the client logs. [See details](https://github.com/jasonwu1995/LeagueClientDebugger/tree/main/LeagueClientDebugger/LeagueHooker)
